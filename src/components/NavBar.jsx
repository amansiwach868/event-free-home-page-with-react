  ...
  <nav>
    <div className="max-w-[1320px] w-full flex justify-between items-center gap-6 mx-auto px-3">
      ...
      <ul className={`flex lg:max-w-[590px] w-full lg:justify-between items-center max-lg:flex-col gap-y-7 justify-center max-lg:fixed max-lg:top-0 max-lg:bg-[#4b5558] z-50 max-lg:min-h-screen duration-300 text-white ${navBar ? 'right-0' : '-right-full'}`}>
        <li className="text-[16px] font-semibold opacity-80 duration-300 hover:opacity-100 overflow-clip"><a className=' after:h-[1px] after:w-full after:bg-white after:content-[""] relative after:absolute after:bottom-0 after:-left-full hover:after:left-0 after:duration-300 ease-in-out' onClick={() => setNavBar(false)} href="#">HOME</a></li>
        <li className="text-[16px] font-semibold opacity-80 duration-300 hover:opacity-100 overflow-clip"><a className=' after:h-[1px] after:w-full after:bg-white after:content-[""] relative after:absolute after:bottom-0 after:-left-full hover:after:left-0 after:duration-300 ease-in-out' onClick={() => setNavBar(false)} href="#">EVENTS</a></li>
        <li className="text-[16px] font-semibold opacity-80 duration-300 hover:opacity-100 overflow-clip"><a className=' after:h-[1px] after:w-full after:bg-white after:content-[""] relative after:absolute after:bottom-0 after:-left-full hover:after:left-0 after:duration-300 ease-in-out' onClick={() => setNavBar(false)} href="#">FEED</a></li>
        <li className="text-[16px] font-semibold opacity-80 duration-300 hover:opacity-100 overflow-clip"><a className=' after:h-[1px] after:w-full after:bg-white after:content-[""] relative after:absolute after:bottom-0 after:-left-full hover:after:left-0 after:duration-300 ease-in-out' onClick={() => setNavBar(false)} href="#">USER NAME</a></li>
